        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <span className="text-gray-400">123 Fitness Street, Heraklion, Crete, Greece</span>
            </div>
            <div className="flex items-start gap-3">
              <Phone className="h-5 w-5 text-primary mt-0.5" />
              <span className="text-gray-400">+30 2810 123456</span>
            </div>
            <div className="flex items-start gap-3">
              <Mail className="h-5 w-5 text-primary mt-0.5" />
              <span className="text-gray-400">info@infinitygym.gr</span>
            </div>
          </div>
        </div>
      </div>
